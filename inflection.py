...
singular(r"(a)naly(sis|ses)$", r"\1nalysis")
singular(r"(b)a(sis|ses)$", r"\1asis")
singular(r"(d)iagno(sis|ses)$", r"\1iagnosis")
singular(r"(p)arenthe(sis|ses)$", r"\1arenthesis")
singular(r"(p)rogno(sis|ses)$", r"\1rognosis")
singular(r"(s)ynop(sis|ses)$", r"\1ynopsis")
singular(r"(t)he(sis|ses)$", r"\1hesis")
